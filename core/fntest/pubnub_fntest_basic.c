...
#define SECONDS 1000
#define CHANNEL_REGISTRY_PROPAGATION_DELAY 3000
...
TEST_DEF(connect_and_send_over_several_channels_in_group_simultaneously) {
    ...
    expect(pnfntst_subscribe_and_check(pbp, NULL, "gr", 10*SECONDS, "\"Test M1\"", "ch", "\"Test M2\"", "two", NULL));
...
TEST_DEF(connect_and_send_over_channel_in_group_and_single_channel_simultaneously) {
    ...
    expect(pnfntst_subscribe_and_check(pbp, "two", "gr", 10*SECONDS, "\"Test M1\"", "ch", "\"Test M2\"", "two", NULL));
...
TEST_DEF(connect_and_send_over_channel_in_group_and_multi_channel_simultaneously) {
    ...
    expect(pnfntst_subscribe_and_check(pbp, "ch,two", "gr", 10*SECONDS, "\"Test M1\"", "ch", "\"Test M1\"", "two", "\"Test M1\"", "three", NULL));
...
TEST_DEF(connect_and_receive_over_several_channels_in_group_simultaneously) {
    ...
    expect(pnfntst_subscribe_and_check(pbp_2, NULL, "gr", 10*SECONDS, "\"Test M2\"", "ch", "\"Test M2-2\"", "two", NULL));
...
TEST_DEF(connect_and_receive_over_channel_in_group_and_single_channel_simultaneously) {
    ...
    expect(pnfntst_subscribe_and_check(pbp_2, "two", "gr", 10*SECONDS, "\"Test M2\"", "ch", "\"Test M2-2\"", "two", NULL));
...
TEST_DEF(connect_and_receive_over_channel_in_group_and_multi_channel_simultaneously) {
    ...
    expect(pnfntst_subscribe_and_check(pbp_2, "ch,two", "gr", 10*SECONDS, "\"Test M2\"", "ch", "\"Test M2-2\"", "two", "\"Test M2-3\"", "three", NULL));
